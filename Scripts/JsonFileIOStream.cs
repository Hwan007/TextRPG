...
public class JsonFileIOStream
{
    ...
    public void SaveItemDataBase()
    {
        Weapon[] weapons = new Weapon[]
        {
            ...
            new Weapon("야구 방망이", 15, "때리는 손맛이 좋습니다.", 200),
            new Weapon("소방 도끼", 25, "빨간색이 인상적인 도끼입니다.", 450),
        ...
        {
            new Armor("천 갑옷",10,"손때가 뭍어있는 천으로 이루어진 갑옷입니다.", 100),
            new Armor("가죽 갑옷",15,"약간 쿰쿰한 냄새가 나는 가죽 갑옷입니다.", 200),
            new Armor("체인 메일",25,"왠만한 무기는 이를 뚫을 수 없을 겁니다.", 450),
            new Armor("풀 플레이트",30,"무한한 자신감을 불어넣어 주는 풀 플래이트입니다.", 600),
